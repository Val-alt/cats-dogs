...
var className,classNameForJQ,translationBreeds,engBreeds,itemId,itemObj,arrPreviousImage,engCatBreeds={},engCatsObj=[];className=$("body").attr("class"),classNameForJQ="."+className+" ";var App={options:{},init:function(){this.animateLine(),this.loadingBreeds(),this.btnLeftRight(),this.searchBreed()},animateLine:()=>{let e,a;a="0px",$(window).width()>"1234"?e="600px":$(window).width()>"646"?e="280px":$(window).width()<="575"&&(e="200px"),$(".option__btn").mouseenter(function(){$(this).find(".option__line").animate({width:e},250)}),$(".option__btn").mouseleave(function(){$(this).find(".option__line").animate({width:"0px"},250)})},getKeyByValue:(e,a)=>Object.keys(e).find(s=>e[s]===a),loadingBreeds:()=>{"main-dogs"===className&&$.getJSON("https://dog.ceo/api/breeds/list/all").then(e=>engBreeds=Object.keys(e.message)).then(e=>{translationBreeds={waterdog:"водяная собака",papillon:"папильён",african:"африканская",cattledog:"пастушья собака",cotondetulear:"котон-де-тулеар",entlebucher:"энтлебухер",eskimo:"эскимосская собака",germanshepherd:"немецкая овчарка",mexicanhairless:"ксолоитцкуинтли",mountain:"зенненхунд",pointer:"пойнтер",pug:"мопс",puggle:"пагль",redbone:"редбон кухаунд",shihtzu:"ши-тцу",stbernard:"сербернар"};for(let a=0;a<e.length;a++){let s=e[a];translationBreeds[s]||App.translateBreeds(s,e)}}).catch(e=>{$(classNameForJQ+"#content").html("не удалось перевести породы собачек")}),"main-cats"===className&&$.getJSON("https://api.thecatapi.com/v1/breeds").then(e=>{let a=e.map(e=>e.origin),s=e.map(e=>e.life_span),t=e.map(e=>e.name),i=e.map(e=>e.id),r=e.map(e=>e.adaptability),l=e.map(e=>e.affection_level),n=e.map(e=>e.child_friendly),o=e.map(e=>e.dog_friendly),m=e.map(e=>e.energy_level),c=e.map(e=>e.grooming),d=e.map(e=>e.health_issues),p=e.map(e=>e.intelligence),h=e.map(e=>e.shedding_level),g=e.map(e=>e.social_needs),b=e.map(e=>e.stranger_friendly),f=e.map(e=>e.vocalisation),u=e.map(e=>e.experimental),N=e.map(e=>e.rare),$=e.map(e=>e.hairless),v=e.map(e=>e.suppressed_tail),_=e.map(e=>e.short_legs);for(let e=0;e<t.length;e++)engCatBreeds[t[e]]=i[e],engCatsObj[e]={name:t[e],id:i[e],origin:a[e],life_span:s[e],adaptability:r[e],affection_level:l[e],child_friendly:n[e],dog_friendly:o[e],energy_level:m[e],grooming:c[e],health_issues:d[e],intelligence:p[e],shedding_level:h[e],social_needs:g[e],stranger_friendly:b[e],vocalisation:f[e],experimental:u[e],rare:N[e],hairless:$[e],suppressed_tail:v[e],short_legs:_[e]};return engCatBreeds}).then(e=>{translationBreeds={Cheetoh:"чито"};for(let a=0;a<Object.keys(e).length;a++){let s=Object.keys(e)[a];translationBreeds[s]||App.translateBreeds(s,e)}}).catch(e=>{$(classNameForJQ+"#content").html("не удалось перевести породы кошечек")})},translateBreeds:(e,a)=>{$.getJSON("https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20190118T073029Z.3f310cb0cd1394d9.52268319f275afdd6bc274241581fc691aa64ccd&text="+e+"&lang=en-ru").then(s=>{let t=s.text[0].toLowerCase();if(translationBreeds[e]=t,Object.keys(translationBreeds).length===Object.keys(a).length){let e,a=Object.values(translationBreeds).sort(),s="";$(classNameForJQ+".spinner-border.load-breed").hide(),$(classNameForJQ+".breeds-dropdown .dropdown-toggle").html('cписок пород <i class="fas fa-check ml-2"></i>'),$(classNameForJQ+".fa-check").fadeOut(600);for(let e of a)s+='<button class="dropdown-item breed-dropdown-item" type="button" value="'+App.getKeyByValue(translationBreeds,e)+'">'+e+"</button>";$(classNameForJQ+".breeds-select").html(s),"main-cats"===className&&(e=engCatBreeds),App.clickDropdown(e)}})},clickDropdown:e=>{$(classNameForJQ+"button.breed-dropdown-item").on("click",function(){arrPreviousImage=[];let e=$(this).html(),a=$(this).val();"main-dogs"===className&&(itemId=a),"main-cats"===className&&(itemId=engCatBreeds[a],itemObj=engCatsObj.find(e=>e.name===a)),App.pictBreed(itemId,e,itemObj)})},pictBreed:(e,a,s)=>{let t;$(classNameForJQ+".load-pict-breed.spinner-border").show(),"main-dogs"===className?t="https://dog.ceo/api/breed/"+e+"/images/random":"main-cats"===className&&(t="https://api.thecatapi.com/v1/images/search?breed_ids="+e),$.getJSON(t).then(e=>{let t;if($(classNameForJQ+".card-title").html(""),$(classNameForJQ+".card-title").html('Порода <span class="breed text-primary">'+a+"</span>"),"main-dogs"===className?t=e.message:"main-cats"===className&&(t=e[0].url),$(classNameForJQ+".load-pict-breed.spinner-border").hide(),$(classNameForJQ+"#content").html('<img class="img-fluid" src="'+t+'">'),"main-cats"===className)for(var i in s)"life_span"==i?$(classNameForJQ+'div[data-param="'+i+'"]').html(s[i]):"experimental"==i||"rare"==i||"hairless"==i||"suppressed_tail"==i||"short_legs"==i?$(classNameForJQ+'div[data-param="'+i+'"]').css("background-image","url('assets/template/img/"+s[i]+"star-one.png')"):"name"!=i&&"id"!=i&&"origin"!=i&&$(classNameForJQ+'div[data-param="'+i+'"]').css("background-image","url('assets/template/img/"+s[i]+"star.png')");arrPreviousImage.push($(classNameForJQ+"#content").html()),$(classNameForJQ+".btnLeft").prop("disabled",!0),$(classNameForJQ+".btnLeft").css("visibility","visible"),$(classNameForJQ+".btnRight").css("visibility","visible"),arrPreviousImage.length>1&&$(classNameForJQ+".btnLeft").prop("disabled",!1)}).catch(()=>{$(classNameForJQ+".load-pict-breed.spinner-border").hide(),$(classNameForJQ+"#content").html("не удалось загрузить картинку")})},btnLeftRight:()=>{$(".btnRight").on("click",()=>{let e=$(classNameForJQ+".breed").html();if(void 0===itemId)return!1;App.pictBreed(itemId,e,itemObj)}),$(".btnLeft").on("click",()=>{if(!(arrPreviousImage.length>1))return!1;$(classNameForJQ+"#content").html(""),$(classNameForJQ+"#content").html(arrPreviousImage[arrPreviousImage.length-2]),arrPreviousImage.pop(),arrPreviousImage.length<=1&&$(classNameForJQ+".btnLeft").prop("disabled",!0)})},searchBreed:()=>{let e,a;$(".text-to-find").keyup(function(s){s.preventDefault();let t,i=$(s.target).val();if("main-dogs"===className&&(t="assets/template/file/dogs.json"),"main-cats"===className&&(t="assets/template/file/cats.json"),$.get(t).then(s=>{e=Object.values(s),a="";for(let s of e){let e=s.substring(0,i.length);i===e&&""!=i&&(a+="<li class='search__item'>"+s+"</li>",$(classNameForJQ+".search").css("display","block"),$(classNameForJQ+".search__items").html(a),$(".search__item").on("click",e=>{arrPreviousImage=[];let a=$(e.target).html(),s=App.getKeyByValue(translationBreeds,a);"main-dogs"===className&&(itemId=s),"main-cats"===className&&(itemId=engCatBreeds[s],itemObj=engCatsObj.find(e=>e.name===s)),App.pictBreed(itemId,a,itemObj),$(classNameForJQ+".text-to-find").val("")}))}""==i&&(a="",$(classNameForJQ+".search__items").html(a),$(classNameForJQ+".search").css("display","none")),$(document).on("click",e=>{$(classNameForJQ+".text-to-find").is(e.target)||(a="",$(classNameForJQ+".search__items").html(a),$(classNameForJQ+".search").css("display","none"))})}).catch(e=>{console.log(e)}),27==s.keyCode&&(this.value="",a="",$(classNameForJQ+".search__items").html(a),$(classNameForJQ+".search").css("display","none")),13==s.keyCode&&(i.length<4&&(alert("Введите четыре или более символов"),this.value=""),i.length>=4)){if(/[a-z\s]/i.engCatsObj($(this).val()))alert("Некорректный ввод"),this.value="";else if(App.getKeyByValue(translationBreeds,i)){arrPreviousImage=[];let e=App.getKeyByValue(translationBreeds,i),a=i;"main-dogs"===className&&(itemId=e),"main-cats"===className&&(itemId=engCatBreeds[e],itemObj=engCatsObj.find(a=>a.name===e)),App.pictBreed(itemId,a,itemObj)}else alert("Такой породы нет, попробуйте еще раз"),this.value=""}})}};$(document).ready(function(){App.init()});