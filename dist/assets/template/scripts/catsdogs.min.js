...
var App={options:{},init:function(){this.animateLine()},animateLine:function(){var e;$(window).width()>"1234"?e="600px":$(window).width()>"646"?e="280px":$(window).width()<="575"&&(e="200px"),$(".option__btn").mouseenter(function(){$(this).find(".option__line").animate({width:e},250)}),$(".option__btn").mouseleave(function(){$(this).find(".option__line").animate({width:"0px"},250)})}};$(document).ready(function(){App.init()});var translations,itemBreed,itemRusBreed,translations1,YA_TRANSLATE_KEY="trnsl.1.1.20190118T073029Z.3f310cb0cd1394d9.52268319f275afdd6bc274241581fc691aa64ccd",$loading=$("#message").hide();function getKeyByValue(e,t){return Object.keys(e).find(a=>e[a]===t)}function Dogs(e,t){$(".load-dog.spinner-border").show(),$.getJSON("https://dog.ceo/api/breed/"+e+"/images/random").then(e=>{$(".card-title").html(""),$(".card-title").html('Собачки породы <span class="breed text-primary">'+t+"</span>"),$(".load-dog.spinner-border").hide(),$("#content").html('<img class="img-fluid" src="'+e.message+'">'),arrPreviousImage.push($("#content").html()),$("#btnLeft").prop("disabled",!0),$("#btnLeft").css("visibility","visible"),$("#btnRight").css("visibility","visible"),arrPreviousImage.length>1&&$("#btnLeft").prop("disabled",!1)}).catch(()=>{$(".load-dog.spinner-border").hide(),$("#content").html("не удалось загрузить собачку")})}function clickDropdown(){$(".main-dogs button.dropdown-item").on("click",function(){arrPreviousImage=[],itemBreed=$(this).val(),itemRusBreed=$(this).html(),Dogs(itemBreed,itemRusBreed)})}$.getJSON("https://dog.ceo/api/breeds/list/all").then(e=>{return Object.keys(e.message)}).then(e=>{translations={waterdog:"водяная собака",papillon:"папильён",african:"африканская",cattledog:"пастушья собака",cotondetulear:"котон-де-тулеар",entlebucher:"энтлебухер",eskimo:"эскимосская собака",germanshepherd:"немецкая овчарка",mexicanhairless:"ксолоитцкуинтли",mountain:"зенненхунд",pointer:"пойнтер",pug:"мопс",puggle:"пагль",redbone:"редбон кухаунд",shihtzu:"ши-тцу",stbernard:"сербернар"};for(let t=0;t<e.length;t++){let a=e[t];translations[a]||$.getJSON("https://translate.yandex.net/api/v1.5/tr.json/translate?key="+YA_TRANSLATE_KEY+"&text="+a+"&lang=en-ru").then(t=>{var i=t.text[0].toLowerCase();if(translations[a]=i,Object.keys(translations).length===e.length){var s=Object.values(translations).sort(),n="";$(".spinner-border.load-breed").hide(),$(".dropdown-toggle").html('cписок пород <i class="fas fa-check ml-2"></i>'),$(".fa-check").fadeOut(600);for(let e of s)n+='<button class="dropdown-item" type="button" value="'+getKeyByValue(translations,e)+'">'+e+"</button>";$(".dogs-select").html(n),clickDropdown()}})}}).catch(e=>{$("#content").html("не удалось перевести породы собачек")}),$("#btnRight").on("click",()=>{if(void 0===itemBreed)return!1;Dogs(itemBreed,itemRusBreed)}),$("#btnLeft").on("click",()=>{if(!(arrPreviousImage.length>1))return!1;$("#content").html(""),$("#content").html(arrPreviousImage[arrPreviousImage.length-2]),arrPreviousImage.pop(),arrPreviousImage.length<=1&&$("#btnLeft").prop("disabled",!0)}),$("#text-to-find").keyup(function(e){e.preventDefault();var t=$(e.target).val();if($.get("ajax/dogs.json").then(e=>{var a=Object.values(e);let i="";for(let e of a){let a=e.substring(0,t.length);t===a&&""!=t&&(i+="<li class='search__item'>"+e+"</li>",$(".search").css("display","block"),$(".search__items").html(i),$(".search__item").on("click",e=>{arrPreviousImage=[],itemRusBreed=$(e.target).html(),Dogs(itemBreed=getKeyByValue(translations,itemRusBreed),itemRusBreed),$("#text-to-find").val("")}))}""==t&&(i="",$(".search__items").html(i),$(".search").css("display","none")),$(document).on("click",e=>{$("#text-to-find").is(e.target)||(i="",$(".search__items").html(i),$(".search").css("display","none"))})}),27==e.keyCode&&(this.value="",html="",$(".search__items").html(html),$(".search").css("display","none")),13==e.keyCode&&(t.length<4&&(alert("Введите четыре или более символов"),this.value=""),t.length>=4)){/[a-z\s]/i.test($(this).val())?(alert("Некорректный ввод"),this.value=""):getKeyByValue(translations,t)?(arrPreviousImage=[],Dogs(itemBreed=getKeyByValue(translations,t),itemRusBreed=t)):(alert("Такой породы нет, попробуйте еще раз"),this.value="")}});var itemBreed1,itemRusBreed1,itemId1,catObj,engBreeds12={},test=[];function Cats(e,t,a){$(".load-cat.spinner-border").show(),$.getJSON("https://api.thecatapi.com/v1/images/search?breed_ids="+e).then(e=>{let i=e[0].url;for(var s in $(".card-title1").html(""),$(".card-title1").html('Кошечки породы <span class="breed text-primary">'+t+"</span>"),$(".load-cat.spinner-border").hide(),$("#content1").html('<img class="img-fluid" src="'+i+'">'),a)"life_span"==s?$('div[data-param="'+s+'"]').html(a[s]):"experimental"==s||"rare"==s||"hairless"==s||"suppressed_tail"==s||"short_legs"==s?$('div[data-param="'+s+'"]').css("background-image","url('img/"+a[s]+"star-one.png')"):"name"!=s&&"id"!=s&&"origin"!=s&&$('div[data-param="'+s+'"]').css("background-image","url('img/"+a[s]+"star.png')");arrPreviousImage1.push($("#content1").html()),$("#btnLeft1").prop("disabled",!0),$("#btnLeft1").css("visibility","visible"),$("#btnRight1").css("visibility","visible"),arrPreviousImage1.length>1&&$("#btnLeft1").prop("disabled",!1)}).catch(()=>{$(".load-cat.spinner-border").hide(),$("#content1").html("не удалось загрузить кошечку")})}function clickDropdown1(){$(".main-cats button.dropdown-item").on("click",function(){arrPreviousImage1=[],itemBreed1=$(this).val(),itemId1=engBreeds12[itemBreed1],itemRusBreed1=$(this).html(),catObj=test.find(e=>e.name===itemBreed1),Cats(itemId1,itemRusBreed1,catObj)})}$.getJSON("https://api.thecatapi.com/v1/breeds").then(e=>{let t=e.map(e=>e.origin),a=e.map(e=>e.life_span),i=e.map(e=>e.name),s=e.map(e=>e.id),n=e.map(e=>e.adaptability),r=e.map(e=>e.affection_level),l=e.map(e=>e.child_friendly),o=e.map(e=>e.dog_friendly),d=e.map(e=>e.energy_level),m=e.map(e=>e.grooming),c=e.map(e=>e.health_issues),h=e.map(e=>e.intelligence),g=e.map(e=>e.shedding_level),p=e.map(e=>e.social_needs),u=e.map(e=>e.stranger_friendly),$=e.map(e=>e.vocalisation),f=e.map(e=>e.experimental),b=e.map(e=>e.rare),v=e.map(e=>e.hairless),_=e.map(e=>e.suppressed_tail),y=e.map(e=>e.short_legs);for(let e=0;e<i.length;e++)engBreeds12[i[e]]=s[e],test[e]={name:i[e],id:s[e],origin:t[e],life_span:a[e],adaptability:n[e],affection_level:r[e],child_friendly:l[e],dog_friendly:o[e],energy_level:d[e],grooming:m[e],health_issues:c[e],intelligence:h[e],shedding_level:g[e],social_needs:p[e],stranger_friendly:u[e],vocalisation:$[e],experimental:f[e],rare:b[e],hairless:v[e],suppressed_tail:_[e],short_legs:y[e]};return engBreeds12}).then(e=>{translations1={Cheetoh:"чито"};for(let t=0;t<Object.keys(e).length;t++){let a=Object.keys(e)[t];translations1[a]||$.getJSON("https://translate.yandex.net/api/v1.5/tr.json/translate?key="+YA_TRANSLATE_KEY+"&text="+a+"&lang=en-ru").then(t=>{var i=t.text[0].toLowerCase();if(translations1[a]=i,Object.keys(translations1).length===Object.keys(e).length){var s=Object.values(translations1).sort(),n="";$(".spinner-border.load-breed").hide(),$(".dropdown-toggle1").html('cписок пород <i class="fas fa-check ml-2"></i>'),$(".fa-check").fadeOut(600);for(let e of s)n+='<button class="dropdown-item" type="button" value="'+getKeyByValue(translations1,e)+'">'+e+"</button>";$(".dogs-select1").html(n),clickDropdown1()}})}}).catch(e=>{$("#content").html("не удалось перевести породы кошечек")}),$("#btnRight1").on("click",()=>{if(void 0===itemId1)return!1;Cats(itemId1,itemRusBreed1)}),$("#btnLeft1").on("click",()=>{if(!(arrPreviousImage1.length>1))return!1;$("#content1").html(""),$("#content1").html(arrPreviousImage1[arrPreviousImage1.length-2]),arrPreviousImage1.pop(),arrPreviousImage1.length<=1&&$("#btnLeft").prop("disabled",!0)}),$("#text-to-find").keyup(function(e){e.preventDefault();var t=$(e.target).val();if($.get("ajax/cats.json").then(e=>{var a=Object.values(e);let i="";for(let e of a){let a=e.substring(0,t.length);t===a&&""!=t&&(i+="<li class='search__item'>"+e+"</li>",$(".search").css("display","block"),$(".search__items").html(i),$(".search__item").on("click",e=>{arrPreviousImage1=[],itemRusBreed=$(e.target).html(),itemBreed1=getKeyByValue(translations1,itemRusBreed),itemId1=engBreeds12[itemBreed1],catObj=test.find(e=>e.name===itemBreed1),console.log(itemRusBreed),Cats(itemId1,itemRusBreed,catObj),$("#text-to-find").val("")}))}""==t&&(i="",$(".search__items").html(i),$(".search").css("display","none")),$(document).on("click",e=>{$("#text-to-find").is(e.target)||(i="",$(".search__items").html(i),$(".search").css("display","none"))})}),27==e.keyCode&&(this.value="",html="",$(".search__items").html(html),$(".search").css("display","none")),13==e.keyCode&&(t.length<4&&(alert("Введите четыре или более символов"),this.value=""),t.length>=4)){/[a-z\s]/i.test($(this).val())?(alert("Некорректный ввод"),this.value=""):(console.log(translations1),getKeyByValue(translations1,t)?(arrPreviousImage1=[],itemBreed1=getKeyByValue(translations1,t),itemRusBreed=t,itemId1=engBreeds12[itemBreed1],catObj=test.find(e=>e.name===itemBreed1),Cats(itemId1,itemRusBreed,catObj)):(alert("Такой породы нет, попробуйте еще раз"),this.value=""))}});